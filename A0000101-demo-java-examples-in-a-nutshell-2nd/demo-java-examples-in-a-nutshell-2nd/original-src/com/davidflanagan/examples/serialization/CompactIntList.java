...
public class CompactIntList extends IntList implements Externalizable {
	 ...
	 * to modify the externalization format, but still retain compatibility with
	 ...
	 * state of the object. A no-arg constructor will be called to re-create the
	 * object, and this method must read the state written by writeExternal() to
