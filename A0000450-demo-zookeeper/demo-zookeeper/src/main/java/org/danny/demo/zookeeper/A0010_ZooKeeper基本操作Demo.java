package org.danny.demo.zookeeper;
...
public class A0010_ZooKeeper基本操作Demo {
	...
	public static void main(String[] args) throws IOException, KeeperException, InterruptedException {
		// 创建一个与服务器的连接
		ZooKeeper zk = new ZooKeeper("192.168.11.133:" + CLIENT_PORT, CONNECTION_TIMEOUT, new Watcher() {
			// 监控所有被触发的事件
